...
You can obtain a TMDb API key by creating an account at https://www.themoviedb.org/ and generating an API key in your account settings.
Create a free application at https://clerk.com/ and copy the publishable key from the dashboard.

Run the development server
npm run dev
The app will be available at http://localhost:5173/. Sign up with Clerk to access the dashboard and watchlist features.
